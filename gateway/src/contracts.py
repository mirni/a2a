...
class IdentityService(Protocol):
    ...
    async def register_agent(self, agent_id: str, public_key: str | None = None) -> Any: ...
    ...
    async def submit_metrics(self, agent_id: str, metrics: dict, data_source: str = "self_reported") -> Any: ...
...
class MessagingService(Protocol):
    ...
    async def get_messages(self, agent_id: str, thread_id: str | None = None, limit: int = 50) -> list: ...
...
class PaymentService(Protocol):
    ...
    async def cancel_subscription(self, sub_id: str, cancelled_by: str | None = None) -> Any: ...

    async def reactivate_subscription(self, sub_id: str) -> Any: ...

    async def get_payment_history(self, agent_id: str, limit: int = 100, offset: int = 0) -> list: ...

    async def partial_capture(self, intent_id: str, amount: float) -> tuple: ...
...
class TrustService(Protocol):
    ...
    async def update_server(self, server_id: str, name: str | None = None, url: str | None = None) -> Any: ...
