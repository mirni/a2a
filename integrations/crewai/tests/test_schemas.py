...
class TestGetBalanceInput:
    def test_valid(self):
        from a2a_crewai._schemas import GetBalanceInput
...
class TestDepositInput:
    def test_valid(self):
        from a2a_crewai._schemas import DepositInput
...
class TestCreatePaymentIntentInput:
    def test_valid(self):
        from a2a_crewai._schemas import CreatePaymentIntentInput
...
class TestCapturePaymentInput:
    def test_valid(self):
        from a2a_crewai._schemas import CapturePaymentInput
...
class TestCreateEscrowInput:
    def test_valid(self):
        from a2a_crewai._schemas import CreateEscrowInput
...
class TestReleaseEscrowInput:
    def test_valid(self):
        from a2a_crewai._schemas import ReleaseEscrowInput
...
class TestSearchServicesInput:
    def test_valid(self):
        from a2a_crewai._schemas import SearchServicesInput
...
class TestGetTrustScoreInput:
    def test_valid(self):
        from a2a_crewai._schemas import GetTrustScoreInput
...
class TestRegisterAgentInput:
    def test_valid(self):
        from a2a_crewai._schemas import RegisterAgentInput
...
class TestSendMessageInput:
    def test_valid(self):
        from a2a_crewai._schemas import SendMessageInput
    ...
    def test_optional_fields(self):
        ...
        m = SendMessageInput(
            sender="a", recipient="b", message_type="text", body="hi", subject="greetings", thread_id="t1"
        )
...
class TestAllSchemasHaveExamples:
    ...
    def test_all_schemas_have_schema_extra(self):
        from a2a_crewai import _schemas
        ...
        for cls in schema_classes:
            ...
            assert config.get("json_schema_extra") is not None, f"{cls.__name__} missing json_schema_extra"
